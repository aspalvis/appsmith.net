...
var volumesDir = $"{AppHostExtensions.GetRepoRootDir()}/volumes";
...
var postgres = builder.AddPostgres("postgres", username, password, port: 5432)
    .WithOtlpExporter()
    .WithBindMount($"{volumesDir}/postgres/data", "/var/lib/postgresql/data");

var appSmith = builder.AddContainer("appsmith", "index.docker.io/appsmith/appsmith-ee")
    .WithBindMount($"{volumesDir}/appsmith/appsmith-stacks", "/appsmith-stacks")
